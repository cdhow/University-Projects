...
// Defaults
Line::Line() : Shape(0, 0, '0'), xp{0}, yp{0} {}
Line::Line(int x, int y, int xp, int yp, char s) : Shape(x, y, s), xp{xp}, yp{yp}{}

// Copy Constructor
Line::Line(Line const & that) : Shape(that), xp{that.xp}, yp{that.yp} {}
// Move Constructor
Line::Line(Line && that) noexcept : Shape(std::move(that)), xp{std::move(that.xp)}, yp{std::move(that.yp)}
{
