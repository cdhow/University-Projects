...
// Defaults
Ellipse::Ellipse() : Shape(0, 0, '0'), a{0}, b{0} {}
Ellipse::Ellipse(int x, int y, int a, int b, char s) : Shape(x, y, s), a{a}, b{b} {}

// Copy Constructor
Ellipse::Ellipse(Ellipse const & that) : Shape(that), a{that.a}, b{that.b} {}
// Move Constructor
Ellipse::Ellipse(Ellipse && that) noexcept : Shape(std::move(that)), a{std::move(that.a)}, b{std::move(that.b)}
{
