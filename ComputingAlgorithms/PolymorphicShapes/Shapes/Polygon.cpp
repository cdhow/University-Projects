...
// Defaults
Polygon::Polygon() : Shape(0, 0, '0'), n{0}, l{0} {}
Polygon::Polygon(int x, int y, int n, int l, char s) : Shape(x, y, s), n{n}, l{l} {}

// Copy Constructor
Polygon::Polygon(Polygon const & that) : Shape(that), n{that.n}, l{that.l} {}
// Move Constructor
Polygon::Polygon(Polygon && that) noexcept : Shape(std::move(that)), n{std::move(that.n)}, l{std::move(that.l)}
{
